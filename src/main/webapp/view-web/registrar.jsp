...
<head>
    ...
    <title>Material Dashboard PRO by Creative Tim | Registro y creación de la cuenta</title>
    ...
    <link href="../assets/css/material-dashboard.css_v=1.2.1.css" rel="stylesheet" />
    ...
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard.html">Mi Factura Móvil</a>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right"> 
					...
					<li class="">
                        <a href="register.html">
                            <i class="material-icons">monetization_on</i> Promociones
                        </a>
                    </li>
                    <li class=" active ">
                        <a href="register.html">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="card card-signup">
                            <h2 class="card-title text-center">Regístrate totalmente gratis</h2>
                            <div class="row">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <a href="register.html#something">terminos y condiciones</a>.
                                                </label>
                                            </div>
                                        </div>
                                        <div class="footer text-center">
                                            <a href="register.html#pablo" class="btn btn-primary btn-round">Registrarme</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="http://www.creative-tim.com"> Mi Factura Móvil </a>, el mejor sistema de facturación web
                    </p>
                </div>
            </footer>
        </div>
...
<script src="../assets/js/material-dashboard.js_v=1.2.1"></script>
