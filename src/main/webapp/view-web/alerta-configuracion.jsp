                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="card card-signup">
                            <h2 class="card-title text-center">Ya estas a unos pasos !!!</h2>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form class="form">
                                        ...
                                        <i class="material-icons">picture_as_pdf</i> with icon
                                    <div class="ripple-container"></div></button>
                                    </div>
	                                        <div class="footer text-center">
	                                            <a href="register.html#pablo" class="btn btn-primary btn-round">Continuar</a>
	                                        </div>
