...
<title> Material Kit PRO by Creative Tim </title>
...
<meta itemprop="image" content="http://s3.amazonaws.com/creativetim_bucket/products/46/original/opt_mkp_thumbnail.jpg">
...
<meta name="twitter:image" content="http://s3.amazonaws.com/creativetim_bucket/products/46/original/opt_mkp_thumbnail.jpg">
...
<meta property="og:image" content="http://s3.amazonaws.com/creativetim_bucket/products/46/original/opt_mkp_thumbnail.jpg"/>
...
<!-- Documentation APP -->
<link rel="stylesheet" href="./assets/css/material-kit.min.css?v=2.0.1">
  ...
  <div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url('assets/img/bg0.jpg');">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12 ml-auto">
					<div class="image-container">
						<img class="components-macbook" src="assets/img/presentation-page/laptop-basics.png" alt="" />
						...
						<img class="pin-btn-img" src="assets/img/presentation-page/pin-btn.jpg" alt="" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 ml-auto">
					<div class="image-container">
						<img class="ipad-img" src="assets/img/presentation-page/presentation-ipad.jpg">
						<img class="area-img add-animation animated" src="assets/img/presentation-page/ipad-comments.jpg">
						<img class="info-img add-animation animated" src="assets/img/presentation-page/ipad-table.jpg">
					</div>
				</div>
	...
	<div class="section section-sections">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/h_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/h_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/h_3.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/h_4.jpg" alt="">
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/f_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/f_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/f_3.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/f_4.jpg" alt="">
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/f_5.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/b_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/b_3.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/b_4.jpg" alt="">
				</div>
			</div>

			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/b_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/p_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/p_3.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/p_4.jpg" alt="">
				</div>
			</div>

			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/p_5.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/p_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/pro_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/pro_3.jpg" alt="">
				</div>
			</div>

			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/m_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/pro_1.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/t_2.jpg" alt="">
				</div>
				<div class="col-md-3">
					<img src="assets/img/t_3.jpg" alt="">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/t_1.jpg" alt="">
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<img src="assets/img/m_2.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-md-4">
					...
					<div class="card">
						<a href="examples/about-us.html" target="_blank">
							<img src="assets/img/ex-about-us.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/landing-page.html" target="_blank">
							<img src="assets/img/ex-landing.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/contact-us.html" target="_blank">
							<img src="assets/img/ex-contact.jpg" alt="">
						</a>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="card">
						<a href="examples/blog-post.html" target="_blank">
							<img src="assets/img/ex-blog-post.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/product-page.html" target="_blank">
							<img src="assets/img/ex-product.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/login-page.html" target="_blank">
							<img src="assets/img/ex-login.jpg" alt="">
						</a>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="card">
						<a href="examples/pricing.html" target="_blank">
							<img src="assets/img/ex-pricing.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/signup-page.html" target="_blank">
							<img src="assets/img/ex-register.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/profile-page.html" target="_blank">
							<img src="assets/img/ex-profile.jpg" alt="">
						</a>
					</div>
					...
					<div class="card">
						<a href="examples/blog-posts.html" target="_blank">
							<img src="assets/img/ex-blog-posts.jpg" alt="">
						</a>
					</div>
	...
	<div class="section section-overview">
		<div class="features-5" style="background-image: url(./assets/img/features-5.jpg;)">
			...
			<div class="container">
						...
						<div class="card card-profile card-plain">
							<div class="row">
								<div class="col-md-3">
									...
									<div class="colored-shadow" style="background-image: url(&quot;assets/img/test1.jpg&quot;); opacity: 1;"></div></div>
								</div>
								<div class="col-md-9">
									<div class="card-body">
						...
						<div class="card card-profile card-plain">
							<div class="row">
								<div class="col-md-3">
									...
									<div class="colored-shadow" style="background-image: url(&quot;assets/img/test2.jpg&quot;); opacity: 1;"></div></div>
								</div>
								<div class="col-md-9">
									<div class="card-body">
						...
						<div class="card card-profile card-plain">
							<div class="row">
								<div class="col-md-3">
									...
									<div class="colored-shadow" style="background-image: url(&quot;assets/img/test3.jpg&quot;); opacity: 1;"></div></div>
								</div>
								<div class="col-md-9">
									<div class="card-body">
				...
				<div class="our-clients">
					<div class="row">
						...
						<div class="col-md-3">
							<img src="assets/img/stanford.jpg" alt="">
						</div>
...
<div class="section section-pricing pricing-5">
	<div class="container">
		<div class="row">
			<div class="col-md-8 ml-auto mr-auto text-center">
				<h2 class="title">Ready to grab Material Kit PRO?</h2>
				<ul class="nav nav-pills nav-pills-rose">
                  	<li class="nav-item">
						<a class="nav-link active" href="#personal" data-toggle="tab">Personal License</a>
					</li>
                  	<li class="nav-item">
						<a class="nav-link" href="#commercial" data-toggle="tab">Developer License</a>
					</li>
                </ul>
			</div>
							...
							<div class="col-md-6">
								<div class="card card-pricing card-margin">
									<div class="card-body">
										...
										<a href="http://www.creative-tim.com/buy/material-kit-pro?license=1" class="btn btn-rose btn-round">
											Buy Now!
										</a>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="card card-pricing">
									<div class="card-body">
										...
										<a href="http://www.creative-tim.com/buy/material-kit-pro?license=1&amp;package=3" class="btn btn-rose btn-round">
											Buy Now!
										</a>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="card card-pricing card-margin">
									<div class="card-body">
										...
										<a href="http://www.creative-tim.com/buy/material-kit-pro?license=2" class="btn btn-rose btn-round">
											Buy Now!
										</a>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="card card-pricing">
									<div class="card-body">
										...
										<a href="http://www.creative-tim.com/buy/material-kit-pro?license=2&amp;package=3" class="btn btn-rose btn-round">
											Buy Now!
										</a>
									</div>
								</div>
...
<script src="./assets/js/material-kit.min.js?v=2.0.1"></script>

<!-- Fixed Sidebar Nav - js With initialisations For Demo Purpose, Don't Include it in your project -->
<script src="./assets/js/material-kit-demo.js"></script>
